...
const SpotifyAPI = {
    getAccessToken() {
        ...
        // Case 3: No accessToken, redirect to Spotify authorization
            ...
            const authenticationUrl = `${encodeURIComponent(baseUrl)}?client_id=${encodeURIComponent(clientId)}&redirect_uri=${redirectUri}&scope=${encodeURIComponent(scopes.join(' '))}&response_type=token&show_dialog=true`;
